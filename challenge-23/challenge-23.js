(function(window, document){
  ...
  */
  ...
  $buttonCE.addEventListener('click', handlerClickCE, false);
  $buttonEqual.addEventListener('click', handlerCliclEqual, false);

  //esta funcao pode ou nao ter um param event
