  (function(){
    ...
    */
    ...
    console.log(getFullName.call(personA));
    console.log(getFullName.call(personB));
    ...
    */
    function sum(){
      ...
      function(accumulated, actualItem){
        ...
        // USAR O Number(accumulated) +Number(accumulated);
      });
    }
    ...
    */
    ...
    console.log( sum(13, 20, 87, 2, 10) );
    console.log( sum(10, 20, 330, 100) );
    ...
    */
    ...
    console.log(justNumbers('r4b3ns 87, 7'));
