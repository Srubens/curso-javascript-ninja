(function(window, document){
  ...
  */
  ...
  function calculateAllValue(accumulated, actual) {
    ...
    return doOperation(operator, firstValue, lastOperator, lastValue) + lastOperator;
  }
  ...
  function doOperation(operator, firstValue, lastOperator, lastValue){
    switch (operator) {
      case '+':
