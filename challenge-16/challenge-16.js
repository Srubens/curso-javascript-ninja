(function(){
    ...
    */
    ...
    var len = name.length;
    for(a = 0; a < len; a++){
        console.log( name[a] + ' é a '+ (a + 1) +' letra do meu nome.' );
    }
    ...
    */
    ...
    var fullName = 'rubens-filipe-ferreira-pereira';
    ...
    */
    console.log( '\nMeus amigos:' );
    var friends = [ 'Matheus', 'Likutan', 'Giovane', 'Lucas', 'Silvio', 'jose' ];
    ...
    */
    ...
    var NewName = [];
    for(a = 0; a < len; a++){
        NewName.push( a % 2 === 0 ? myName[a].toLocaleLowerCase() : myName[a].toLocaleUpperCase() );
    }
